...
//			CallCheckedInterfaceMethod(RegIndex reg, RegIndex
// receiver, InterfaceID iface, ConstantID method); 			virtual
//~CallCheckedInterfaceMethod(); 			virtual void
// Compile(llvm::IRBuilder<> &builder, CompileEnv* env, int lineno) override;
//
