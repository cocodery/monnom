...
void Nom::Runtime::ReturnInstruction::Compile(NomBuilder &builder,
  ...
  // }
    ...
    if ((*env)[this->reg].IsFunctionCall()) {
      if (((llvm::CallInst *)(*(*env)[this->reg]))->getCallingConv() ==
          llvm::CallingConv::Fast) {
        ((llvm::CallInst *)(*(*env)[this->reg]))
            ->setTailCallKind(llvm::CallInst::TailCallKind::TCK_Tail);
      }
    }
  }
...
void Nom::Runtime::ReturnInstruction::FillConstantDependencies(
