...
public:
  LoadStringConstantInstruction(const RegIndex reg, const ConstantID constantID)
      : NomValueInstruction(reg, OpCode::LoadStringConstant),
  ...
  //	GenerateLLVMDebugPrint(builder, env->Module, "Loading String
