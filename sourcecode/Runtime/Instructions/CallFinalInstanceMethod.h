...
//			CallFinalInstanceMethod(RegIndex reg, RegIndex receiver,
// ConstantID method); 			virtual ~CallFinalInstanceMethod();
// virtual void Compile(llvm::IRBuilder<> &builder, CompileEnv* env, int lineno)
// override;
//
