...
namespace Nom {
namespace Runtime {
CreateClosure::CreateClosure(RegIndex reg, ConstantID lambda,
                             ConstantID typeArgs)
    : NomValueInstruction(reg, OpCode::CreateClosure), Lambda(lambda),
      TypeArgsID(typeArgs) {}
...
void CreateClosure::FillConstantDependencies(
