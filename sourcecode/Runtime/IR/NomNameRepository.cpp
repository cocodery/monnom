...
size_t NomNameRepository::GetDispatchID(int32_t typeArgCount,
                                        int32_t argCount) {
  std::string name = "@@" + std::to_string(typeArgCount) + "^" +
...
size_t NomNameRepository::GetMaxID() { return names.size(); }
} // namespace Runtime
} // namespace Nom