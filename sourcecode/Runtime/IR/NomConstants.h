...
public:
  ...
  virtual void
  FillConstantDependencies(NOM_CONSTANT_DEPENCENCY_CONTAINER &result) = 0;
};
...
public:
  ...
  void *operator new(size_t count) { return bgc_malloc_uncollectable(count); }

  NomStringConstant(NomString text)
      : NomConstant(NomConstantType::CTString), Text(text) {}
  ...
  const NomString *GetText() { return &Text; }
...
public:
  ...
  NomClassConstant(NomClassConstant &&) = delete;
  NomClassConstant(const ConstantID library, const ConstantID name)
      : NomConstant(NomConstantType::CTClass), Library(library), Name(name) {}
...
public:
  ...
  NomInterfaceConstant(NomInterfaceConstant &&) = delete;
  NomInterfaceConstant(const ConstantID library, const ConstantID name)
      : NomConstant(NomConstantType::CTInterface), Library(library),
        Name(name) {}
...
public:
  ...
  // NomTypeParameterConstant(NomTypeParameterConstant&&) = delete;
  NomTypeParameterConstant(Nom::Runtime::ParameterVariance variance,
                           ConstantID lowerBound, ConstantID upperBound)
      : /*NomConstant(NomConstantType::CTTypeParameter),*/ Variance(variance),
        LowerBound(lowerBound), UpperBound(upperBound) {}
  virtual void
  FillConstantDependencies(NOM_CONSTANT_DEPENCENCY_CONTAINER &result) {
...
public:
  ...
  NomSuperClassConstant(NomSuperClassConstant &&) = delete;
  NomSuperClassConstant(const ConstantID superclass, const ConstantID args)
      : NomConstant(NomConstantType::CTSuperClass), SuperClass(superclass),
        Arguments(args) {}
  virtual ~NomSuperClassConstant() override = default;
  NomInstantiationRef<NomClass>
  GetClassType(NomSubstitutionContextRef context) const;
...
public:
  ...
  NomSuperInterfacesConstant(
      const llvm::SmallVector<std::tuple<ConstantID, ConstantID>, 4> &entries)
      : NomConstant(NomConstantType::CTSuperInterfaces), entries(entries) {}
  virtual ~NomSuperInterfacesConstant() override = default;
  const llvm::ArrayRef<NomInstantiationRef<NomInterface>>
  GetSuperInterfaces(NomSubstitutionContextRef context) const;
...
public:
  ...
  NomTypeListConstant(NomTypeListConstant &&) = delete;
  NomTypeListConstant(const llvm::ArrayRef<ConstantID> types)
      : NomConstant(NomConstantType::CTTypeList) {
    for (auto tid : types) {
  ...
  GetTypeList(NomSubstitutionContextRef context) const;
...
public:
  ...
  NomTypeParametersConstant(
      const llvm::ArrayRef<NomTypeParameterConstant *> typeParams)
      : NomConstant(NomConstantType::CTTypeParameters) {
  ...
  llvm::ArrayRef<NomTypeParameterConstant *> GetParameters() const {
    return typeParams;
  }
...
//	NomClassTypeListConstant(NomClassTypeListConstant&&) = delete;
//	NomClassTypeListConstant(const llvm::SmallVector<ConstantID, 8> &types)
//: NomConstant(NomConstantType::CTTypeList), types(types)
//	{
...
public:
  ...
  NomClassTypeConstant(NomClassTypeConstant &&) = delete;
  NomClassTypeConstant(const ConstantID cls, const ConstantID args)
      : NomConstant(NomConstantType::CTClassType), cls(cls), args(args) {}
...
public:
  ...
  NomTypeVarConstant(const int index)
      : NomConstant(NomConstantType::CTTypeVar), index(index) {}
...
public:
  ...
  NomMaybeTypeConstant(const ConstantID ptype)
      : NomConstant(NomConstantType::CTMaybe), ptype(ptype) {}
...
private:
  ...
  mutable NomInstantiationRef<const NomMethod> method =
...
public:
  ...
  NomMethodConstant(NomMethodConstant &&) = delete;
  NomMethodConstant(const ConstantID cls, const ConstantID methodname,
                    const ConstantID typeArgs, const ConstantID argTypes)
      : NomConstant(NomConstantType::CTMethod), classConstant(cls),
        methodName(methodname), typeArgs(typeArgs), argTypes(argTypes) {}
  virtual ~NomMethodConstant() override = default;
  NomInstantiationRef<const NomMethod>
  GetMethod(NomSubstitutionContextRef context) const;
...
private:
  mutable NomInstantiationRef<const NomStaticMethod> method =
...
public:
  ...
  NomStaticMethodConstant(NomStaticMethodConstant &&) = delete;
  NomStaticMethodConstant(const ConstantID cls, const ConstantID methodname,
                          const ConstantID typeArgs, const ConstantID argTypes)
      : NomConstant(NomConstantType::CTStaticMethod), ClassConstant(cls),
        MethodName(methodname), TypeArgs(typeArgs), ArgTypes(argTypes) {}
  virtual ~NomStaticMethodConstant() override = default;
  NomInstantiationRef<const NomStaticMethod>
  GetStaticMethod(NomSubstitutionContextRef context) const;
...
private:
  mutable NomInstantiationRef<const NomConstructor> constructor =
...
public:
  ...
  NomConstructorConstant(NomConstructorConstant &&) = delete;
  NomConstructorConstant(const ConstantID cls, const ConstantID typeArgs,
                         const ConstantID argTypes)
      : NomConstant(NomConstantType::CTConstructor), ClassConstant(cls),
        TypeArgs(typeArgs), ArgTypes(argTypes) {}
  virtual ~NomConstructorConstant() override = default;
  NomInstantiationRef<const NomConstructor>
  GetConstructor(NomSubstitutionContextRef context) const;
...
public:
  ...
  ConstantID AddClass(LocalConstantID lid, const LocalConstantID library,
                      const LocalConstantID name);
  ConstantID AddInterface(LocalConstantID lid, const LocalConstantID library,
                          const LocalConstantID name);
  ConstantID AddLambda(LocalConstantID lid);
  ConstantID AddStruct(LocalConstantID lid);
  ConstantID AddSuperClass(LocalConstantID lid, const LocalConstantID cls,
                           const LocalConstantID args);
  ConstantID AddSuperInterfaces(
      LocalConstantID lid,
      const llvm::SmallVector<std::tuple<LocalConstantID, LocalConstantID>, 4>
          &entries);
  ConstantID AddMethod(LocalConstantID lid, const LocalConstantID cls,
                       const LocalConstantID name,
                       const LocalConstantID typeArgs,
                       const LocalConstantID argTypes);
  ConstantID AddStaticMethod(LocalConstantID lid, const LocalConstantID cls,
                             const LocalConstantID name,
                             const LocalConstantID typeArgs,
                             const LocalConstantID argTypes);
  ConstantID AddTypeList(LocalConstantID lid,
                         const llvm::SmallVector<LocalConstantID, 8> types);
  ConstantID AddClassType(LocalConstantID lid, const LocalConstantID cls,
                          const LocalConstantID typeArgs);
  ...
  ConstantID
  AddTypeParameters(LocalConstantID lid,
                    llvm::ArrayRef<NomTypeParameterConstant *> parameters);
  ConstantID AddConstructor(LocalConstantID lid, const LocalConstantID cls,
                            const LocalConstantID typeArgs,
                            const LocalConstantID argTypes);
...
private:
  static std::vector<NomConstant *> &constants() {
    static std::vector<NomConstant *> constants(1);
    return constants;
  };
  NomConstants() {}
...
public:
  const NomConstant *operator[](size_t index) { return constants()[index]; }
  ...
  // static NomClassTypeListConstant * GetClassTypeList(const ConstantID
  // constant)
  //{
  //	if (constant == 0)
  //	{
  ...
  static NomSuperInterfacesConstant *
  GetSuperInterfaces(const ConstantID constant);
  static NomInterfaceConstant *GetInterface(const ConstantID constant);
  static NomTypeParametersConstant *
  GetTypeParameters(const ConstantID constant);
  static NomTypeRef GetType(NomSubstitutionContextRef context,
  ...
  static ConstantID AddClass(const ConstantID library, const ConstantID name,
                             ConstantID cid = 0);
  static ConstantID AddInterface(const ConstantID library,
                                 const ConstantID name, ConstantID cid = 0);
  static ConstantID AddLambda(ConstantID cid = 0);
  static ConstantID AddStruct(ConstantID cid);
  static ConstantID AddMethod(const ConstantID cls, const ConstantID name,
                              const ConstantID typeArgs,
                              const ConstantID argTypes, ConstantID cid = 0);
  static ConstantID AddStaticMethod(const ConstantID cls, const ConstantID name,
                                    const ConstantID typeArgs,
                                    const ConstantID argTypes,
                                    ConstantID cid = 0);
  static ConstantID AddConstructor(const ConstantID cls,
                                   const ConstantID typeArgs,
                                   const ConstantID argTypes,
                                   ConstantID cid = 0);
  static ConstantID AddTypeList(const llvm::ArrayRef<ConstantID> types,
                                ConstantID cid = 0);
  static ConstantID AddClassType(const ConstantID cls,
                                 const ConstantID typeArgs, ConstantID cid = 0);
  ...
  // }
  static ConstantID
  AddTypeParameters(llvm::ArrayRef<NomTypeParameterConstant *> typeParameters,
                    ConstantID cid = 0);
  static ConstantID AddSuperClass(const ConstantID cls, const ConstantID args,
                                  ConstantID cid = 0);
  static ConstantID AddSuperInterfaces(
      const llvm::SmallVector<std::tuple<ConstantID, ConstantID>, 4> &entries,
      ConstantID cid = 0);
};
} // namespace Runtime
