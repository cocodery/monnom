...
namespace Nom {
namespace Runtime {
NomStaticMethodLoaded::NomStaticMethodLoaded(
    const std::string &name, const NomClass *parent, const std::string &qname,
    const ConstantID returnType, const ConstantID typeArgs,
    const ConstantID arguments, const int regcount, bool declOnly)
    : NomCallableLoaded(name, parent, qname, regcount, typeArgs, arguments,
                        declOnly, false),
      returnType(returnType), returnTypeBuf(nullptr), Class(parent) {}
llvm::Function *NomStaticMethodLoaded::createLLVMElement(
  ...
  StaticMethodCompileEnv smenv = StaticMethodCompileEnv(
      regcount, *GetSymbolName(), fun, &(this->phiNodes),
      this->GetAllTypeParameters(), this->GetArgumentTypes(nullptr), this);
...
NomTypeRef NomStaticMethodLoaded::GetReturnType(
...
NomStaticMethodLoaded::GetArgumentTypeParameters() const {
  return GetAllTypeParameters();
}

const NomClass *NomStaticMethodLoaded::GetContainer() const { return Class; }

llvm::FunctionType *NomStaticMethod::GetLLVMFunctionType(
    const NomSubstitutionContext *context) const {
...
NomStaticMethodInternal::NomStaticMethodInternal(const std::string &name,
                                                 const std::string &qname,
                                                 const NomClass *cls)
    : NomCallableInternal(name, qname, cls), Container(cls) {}
NomStaticMethodInternal::~NomStaticMethodInternal() {}
llvm::Function *NomStaticMethodInternal::createLLVMElement(
    llvm::Module &mod, llvm::GlobalValue::LinkageTypes linkage) const {
  NomBuilder builder;
...
llvm::ArrayRef<NomTypeParameterRef>
NomStaticMethodInternal::GetArgumentTypeParameters() const {
  return GetAllTypeParameters();
}
...
NomTypeRef NomStaticMethodInternal::GetReturnType(
    const NomSubstitutionContext *context) const {
