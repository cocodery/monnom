...
class NomStaticMethodLoaded : public virtual NomStaticMethod,
                              public NomCallableLoaded {
private:
...
public:
  ...
  NomStaticMethodLoaded(const std::string &name, const NomClass *parent,
                        const std::string &qname, const ConstantID returnType,
                        const ConstantID typeArgs, const ConstantID arguments,
                        const int regcount, bool declOnly = false);
...
class NomStaticMethodInternal : public virtual NomStaticMethod,
...
public:
  ...
  NomStaticMethodInternal(const std::string &name, const std::string &qname,
                          const NomClass *cls);
