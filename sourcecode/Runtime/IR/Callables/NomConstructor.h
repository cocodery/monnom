...
public:
  ...
  NomConstructorLoaded(const NomClass *cls, const std::string &name,
                       const std::string &qname, const ConstantID arguments,
                       const RegIndex regcount, const ConstantID typeArgs,
  ...
  // Inherited via NomCallable
  virtual NomTypeRef
  GetReturnType(const NomSubstitutionContext *context = nullptr) const override;

  virtual const NomClass *GetClass() const override { return Class; }
...
class NomConstructorInternal : public NomConstructor,
