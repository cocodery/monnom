...
public:
  ...
  virtual llvm::FunctionType *GetRawInvokeLLVMFunctionType(
      const NomSubstitutionContext *context = nullptr) const;
...
public:
  ...
  NomMethodLoaded(const NomInterface *container, const std::string &name,
                  const std::string &qname, const ConstantID returnType,
...
class NomMethodDeclLoaded : public virtual NomMethod,
                            public virtual NomCallableLoaded {
private:
  mutable NomTypeRef returnType;
  const ConstantID returnTypeID;

public:
  NomMethodDeclLoaded(const NomInterface *container, const std::string &name,
                      const std::string &qname, const ConstantID returnType,
                      const ConstantID argTypes, ConstantID typeParameters);
...
public:
  const NomInterface *const Container;
  NomMethodInternal(const NomInterface *container, const std::string &name,
...
class NomMethodDeclInternal : public virtual NomMethod,
                              public NomCallableInternal {
private:
  NomTypeRef returnType = nullptr;
...
public:
  ...
  NomMethodDeclInternal(NomInterface *container, const std::string &name,
