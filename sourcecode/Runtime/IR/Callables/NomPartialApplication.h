...
public:
  ...
  NomPartialApplication(const std::string symbolName,
                        llvm::ArrayRef<const NomCallable *> methods,
                        const NomMemberContext *context, NomTypeRef thisType);
  static llvm::FunctionType *
      GetDynamicDispatcherType(/*uint32_t typeargcount, uint32_t argcount*/);
  static llvm::Function *
  GetDispatcherEntry(llvm::Module &mod, llvm::GlobalValue::LinkageTypes linkage,
