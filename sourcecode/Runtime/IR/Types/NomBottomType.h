...
public:
  ...
  static NomBottomTypeRef Instance() {
    static NomBottomType type;
    return &type;
  }
  ...
  // virtual llvm::Constant * GetTypeTemplateReference(uint64_t offset) const
  // override;
  virtual TypeKind GetKind() const override { return TypeKind::TKBottom; }
  // llvm::Constant * GetRTType() const override;
  size_t GetHashCode() const override { return 0; }
