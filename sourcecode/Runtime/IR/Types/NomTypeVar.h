...
public:
  ...
  bool IsSupertype(NomBottomTypeRef other,
                   bool optimistic = true) const override;
  ...
  const std::string GetSymbolRep() const override { return "VAR"; }
  size_t GetHashCode() const override;

public:
  virtual TypeKind GetKind() const override { return TypeKind::TKVariable; }
