...
public:
  ...
  virtual llvm::Value *GenerateRTInstantiation(NomBuilder &builder,
                                               CompileEnv *env) const override;
  virtual size_t GetHashCode() const override;
  virtual bool IsSubtype(NomTypeRef other,
                         bool optimistic = false) const override;
  ...
  virtual bool IsSubtype(NomTypeVarRef other,
                         bool optimistic = false) const override;
  virtual bool IsSupertype(NomTypeRef other,
                           bool optimistic = false) const override;
  ...
  virtual NomTypeRef
  SubstituteSubtyping(const NomSubstitutionContext *context) const override;
  ...
  GetClassInstantiation(const NomNamed *named) const override;
