...
TypeReferenceTypeString(const TypeReferenceType &trt) {
  switch (trt) {
...
public:
  ...
  virtual llvm::Value *GenerateRTInstantiation(NomBuilder &builder,
                                               CompileEnv *env) const = 0;
  ...
  virtual bool IsSubtype(NomBottomTypeRef other,
                         bool optimistic = false) const = 0;
  virtual bool IsSubtype(NomDynamicTypeRef other,
                         bool optimistic = false) const = 0;
  virtual bool IsSubtype(NomClassTypeRef other,
                         bool optimistic = false) const = 0;
  virtual bool IsSubtype(NomTopTypeRef other,
                         bool optimistic = false) const = 0;
  virtual bool IsSubtype(NomTypeVarRef other,
                         bool optimistic = false) const = 0;
  virtual bool IsSubtype(NomMaybeTypeRef other,
                         bool optimistic = false) const = 0;
  virtual bool IsSupertype(NomTypeRef other, bool optimistic = false) const = 0;
  virtual bool IsSupertype(NomDynamicTypeRef other,
                           bool optimistic = false) const = 0;
  virtual bool IsSupertype(NomBottomTypeRef other,
                           bool optimistic = false) const = 0;
  virtual bool IsSupertype(NomClassTypeRef other,
                           bool optimistic = false) const = 0;
  virtual bool IsSupertype(NomTopTypeRef other,
                           bool optimistic = false) const = 0;
  virtual bool IsSupertype(NomTypeVarRef other,
                           bool optimistic = false) const = 0;
  virtual bool IsSupertype(NomMaybeTypeRef other,
                           bool optimistic = false) const = 0;
  ...
  virtual NomTypeRef
  SubstituteSubtyping(const NomSubstitutionContext *context) const = 0;
  ...
  virtual NomClassTypeRef
  GetClassInstantiation(const NomNamed *named) const = 0;
};
...
struct NomTypeRefArrayRefEquality {
  bool operator()(const llvm::ArrayRef<NomTypeRef> &lhs,
                  const llvm::ArrayRef<NomTypeRef> &rhs) const {
