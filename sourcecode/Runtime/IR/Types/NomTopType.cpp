...
NomTypeRef
NomTopType::SubstituteSubtyping(const NomSubstitutionContext *context) const {
  return this;
}
llvm::Value *NomTopType::GenerateRTInstantiation(NomBuilder &builder,
...
const std::string NomTopType::GetSymbolRep() const { return "Anything"; }
llvm::Constant *
NomTopType::createLLVMElement(llvm::Module &mod,
                              llvm::GlobalValue::LinkageTypes linkage) const {
  Function *fun = Function::Create(GetCastFunctionType(), linkage,
                                   "MONNOM_RT_TYPECASTFUN_TOP", mod);
  {
  ...
  return new llvm::GlobalVariable(
      ...
      RTTypeHead::GetConstant(TypeKind::TKTop, MakeInt(GetHashCode()), this,
                              fun),
      "RT_NOM_TopType");
}
...
bool NomTopType::IsDisjoint(NomBottomTypeRef other) const { return true; }
bool NomTopType::IsDisjoint(NomClassTypeRef other) const { return false; }
bool NomTopType::IsDisjoint(NomTopTypeRef other) const { return false; }
bool NomTopType::IsDisjoint(NomTypeVarRef other) const { return false; }
...
bool NomTopType::PossiblyPrimitive() const { return true; }
bool NomTopType::UncertainlyPrimitive() const { return true; }
...
bool NomTopType::IsDisjoint(NomMaybeTypeRef other) const { return false; }
TypeReferenceType NomTopType::GetTypeReferenceType() const {
  return TypeReferenceType::Reference;
}
bool NomTopType::ContainsVariableIndex(int index) const { return false; }
} // namespace Runtime
} // namespace Nom