...
namespace Nom {
namespace Runtime {
NomSubstitutionContextMemberContext::NomSubstitutionContextMemberContext(
    const NomMemberContext *context)
    : context(context) {}
llvm::ArrayRef<NomTypeRef>
NomSubstitutionContextMemberContext::GetTypeParameters() const {
...
NomTypeRef
NomSubstitutionContextMemberContext::GetTypeVariable(int index) const {
...
NomSingleSubstitutionContext::NomSingleSubstitutionContext(
    NomTypeVarRef typeVar, NomTypeRef replacement)
    : typeVar(typeVar), replacement(replacement) {}
llvm::ArrayRef<NomTypeRef>
NomSingleSubstitutionContext::GetTypeParameters() const {
