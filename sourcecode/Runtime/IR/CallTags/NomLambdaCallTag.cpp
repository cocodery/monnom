...
namespace Nom {
namespace Runtime {
NomLambdaCallTag::NomLambdaCallTag(int typeArgCount, int argCount)
    : typeArgCount(typeArgCount), argCount(argCount) {}
const NomLambdaCallTag *NomLambdaCallTag::GetCallTag(int typeArgCount,
                                                     int argCount) {
...
llvm::Constant *NomLambdaCallTag::createLLVMElement(
