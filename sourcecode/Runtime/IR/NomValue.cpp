...
namespace Nom {
namespace Runtime {
NomTypeRef GetIntClassType() { return NomIntClass::GetInstance()->GetType(); }
NomTypeRef GetFloatClassType() {
  return NomFloatClass::GetInstance()->GetType();
}
NomTypeRef GetBoolClassType() { return NomBoolClass::GetInstance()->GetType(); }
NomTypeRef GetDynamicType() { return NomDynamicType::DynamicRef; }
