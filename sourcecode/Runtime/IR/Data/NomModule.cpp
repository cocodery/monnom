...
NomClassLoaded *NomModule::AddClass(ConstantID name, ConstantID typeParameters,
                                    ConstantID superClass,
                                    ConstantID superInterfaces) {
  NomClassLoaded *cls = program->AddClass(name, typeParameters, superClass,
                                          superInterfaces, nullptr);
  this->Classes.push_back(cls);
  return cls;
}

NomInterfaceLoaded *NomModule::AddInterface(ConstantID name,
                                            ConstantID typeParameters,
                                            ConstantID superInterfaces) {
  NomInterfaceLoaded *iface =
      program->AddInterface(name, typeParameters, superInterfaces, nullptr);
