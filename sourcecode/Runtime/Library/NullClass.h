...
namespace Runtime {
class NomNullClass
    : public NomClassInternal //, public
                              // AvailableExternally<llvm::GlobalVariable>
{
private:
  NomNullClass();
...
public:
  ...
  // virtual llvm::GlobalVariable * createLLVMElement(llvm::Module & mod,
  // llvm::GlobalValue::LinkageTypes linkage) const override; virtual
  // llvm::GlobalVariable * findLLVMElement(llvm::Module & mod) const override;
};
...
public:
  static NomNullObject *GetInstance() {
    static NomNullObject obj;
    return &obj;
  }
  ~NomNullObject() {}
