...
namespace Nom {
namespace Runtime {
NomMathClass::NomMathClass()
    : NomInterface("Math_0"), NomClassInternal(new NomString("Math_0"))
// NomClass(NomConstants::AddString(NomString("Object")), 0, 0, 0, nullptr)
{
  ...
  NomTypeRef *floatArr =
      new NomTypeRef[2]{GetFloatClassType(), GetFloatClassType()};

  NomStaticMethodInternal *sin =
      new NomStaticMethodInternal("Sin", "LIB_NOM_Math_Sin_1", this);
  ...
  llvm::sys::DynamicLibrary::AddSymbol("LIB_NOM_Math_Sin_1",
                                       (void *)&LIB_NOM_Math_Sin_1);

  NomStaticMethodInternal *cos =
      new NomStaticMethodInternal("Cos", "LIB_NOM_Math_Cos_1", this);
  ...
  llvm::sys::DynamicLibrary::AddSymbol("LIB_NOM_Math_Cos_1",
                                       (void *)&LIB_NOM_Math_Cos_1);

  NomStaticMethodInternal *tan =
      new NomStaticMethodInternal("Tan", "LIB_NOM_Math_Tan_1", this);
  ...
  llvm::sys::DynamicLibrary::AddSymbol("LIB_NOM_Math_Tan_1",
                                       (void *)&LIB_NOM_Math_Tan_1);

  NomStaticMethodInternal *fmax =
      new NomStaticMethodInternal("FMax", "LIB_NOM_Math_FMax_2", this);
  ...
  llvm::sys::DynamicLibrary::AddSymbol("LIB_NOM_Math_FMax_2",
                                       (void *)&LIB_NOM_Math_FMax_2);

  NomStaticMethodInternal *fmin =
      new NomStaticMethodInternal("FMin", "LIB_NOM_Math_FMin_2", this);
  ...
  llvm::sys::DynamicLibrary::AddSymbol("LIB_NOM_Math_FMin_2",
                                       (void *)&LIB_NOM_Math_FMin_2);

  NomStaticMethodInternal *fsqrt =
      new NomStaticMethodInternal("Sqrt", "LIB_NOM_Math_Sqrt_1", this);
  ...
  llvm::sys::DynamicLibrary::AddSymbol("LIB_NOM_Math_Sqrt_1",
                                       (void *)&LIB_NOM_Math_Sqrt_1);
}

NomMathClass *NomMathClass::GetInstance() {
  static NomMathClass noc;
  return &noc;
}
} // namespace Runtime
} // namespace Nom
