...
// Nom::Runtime::NomVoidClass *_NomVoidClass=
...
// const Nom::Runtime::NomClassType VOIDNOMCLASSTYPE(&_NomVoidClass,
// Nom::Runtime::TypeList()); extern "C" const Nom::Runtime::NomType * const
// VOIDNOMTYPE = &VOIDNOMCLASSTYPE;

namespace Nom {
namespace Runtime {
NomVoidClass::NomVoidClass()
    : NomInterface("Void_0"), NomClassInternal(new NomString("Void_0"))
...
llvm::Constant *NomVoidObject::createLLVMElement(
  ...
  return ObjectHeader::GetGlobal(mod, linkage, "RT_NOM_VOIDOBJ",
