...
IEnumeratorInterface::IEnumeratorInterface()
    : NomInterface("IEnumerator_1"),
      NomInterfaceInternal(new NomString("IEnumerator_1")) {
...
IEnumeratorInterface *IEnumeratorInterface::GetInstance() {
  ...
  if (once) {
    once = false;
    NomMethodDeclInternal *meth =
        new NomMethodDeclInternal(&iei, "MoveNext", "IEnumerator$$MoveNext");
