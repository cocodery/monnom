...
// const Nom::Runtime::NomNullClass *_NomNullClass=
...
// const Nom::Runtime::NomClassType NULLNOMCLASSTYPE(&_NomNullClass,
// Nom::Runtime::TypeList()); extern "C" const Nom::Runtime::NomType * const
// NULLNOMTYPE = &NULLNOMCLASSTYPE;
...
// ObjectHeader::GetLLVMType(_NomNullClass.GetClassDescriptorType());
// ret = new llvm::GlobalVariable(mod, type, true, (&mod != mainModule ?
//(llvm::GlobalValue::LinkageTypes::AvailableExternallyLinkage) :
//(llvm::GlobalValue::LinkageTypes::ExternalLinkage)), nullptr, "NOM_NULLOBJ");
//		ret->setInitializer(ObjectHeader::GetConstant(type,
//_NomNullClass.GetLLVMElement(mod)));
//	}
//	return ret;
// }
NomNullClass::NomNullClass()
    : NomInterface("Null_0"), NomClassInternal(new NomString("Null_0"))
...
NomNullClass *NomNullClass::GetInstance() {
  static NomNullClass nnc;
  return &nnc;
}
NomNullObject::NomNullObject() {}
llvm::Constant *NomNullObject::createLLVMElement(
    llvm::Module &mod, llvm::GlobalValue::LinkageTypes linkage) const {
  auto cls = NomNullClass::GetInstance();
  // llvm::StructType *type =
  // ObjectHeader::GetLLVMType(cls->GetLLVMElement(mod)->getType());
  return ObjectHeader::GetGlobal(mod, linkage, "RT_NOM_NULLOBJ",
...
// llvm::GlobalVariable * NomNullClass::createLLVMElement(llvm::Module & mod,
// llvm::GlobalValue::LinkageTypes linkage) const
//{
//	llvm::StructType *type =
// ObjectHeader::GetLLVMType(_NomNullClass.GetClassDescriptorType()); 	ret =
// new llvm::GlobalVariable(mod, type, true, linkage, nullptr, "NOM_NULLOBJ");
//	ret->setInitializer(ObjectHeader::GetConstant(type,
//_NomNullClass.GetLLVMElement(mod, refOnly))); 	return ret;
// }
// llvm::GlobalVariable * NomNullClass::findLLVMElement(llvm::Module & mod)
// const
//{
