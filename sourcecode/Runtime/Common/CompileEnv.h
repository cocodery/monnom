...
class CompileEnv {
protected:
  CompileEnv(const llvm::Twine contextName, llvm::Function *function,
...
public:
  ...
  ACompileEnv(const RegIndex regcount, const llvm::Twine contextName,
...
public:
  AFullArityCompileEnv(const RegIndex regcount, const llvm::Twine contextName,
                       llvm::Function *function,
                       const NomMemberContext *context,
                       const std::vector<PhiNode *> *phiNodes,
                       const llvm::ArrayRef<NomTypeParameterRef> directTypeArgs,
...
public:
  ...
  InstanceMethodCompileEnv(
      RegIndex regcount, const llvm::Twine contextName,
      llvm::Function *function, const std::vector<PhiNode *> *phiNodes,
      const llvm::ArrayRef<NomTypeParameterRef> directTypeArgs,
...
public:
  ...
  LambdaCompileEnv(RegIndex regcount, const llvm::Twine contextName,
                   llvm::Function *function,
                   const std::vector<PhiNode *> *phiNodes,
                   const llvm::ArrayRef<NomTypeParameterRef> directTypeArgs,
