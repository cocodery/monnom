...
namespace Nom {
namespace Runtime {
llvm::CallInst *GenerateFunctionCall(NomBuilder &builder, llvm::Module &mod,
                                     llvm::Value *fun,
...
llvm::StoreInst *
MakeStore(NomBuilder &builder, llvm::Module &mod, llvm::Value *val,
          llvm::Value *ptr,
          llvm::AtomicOrdering ordering = llvm::AtomicOrdering::Unordered);
llvm::StoreInst *
MakeStore(NomBuilder &builder, llvm::Value *val, llvm::Value *ptr,
          llvm::AtomicOrdering ordering = llvm::AtomicOrdering::Unordered);
llvm::StoreInst *
MakeStore(NomBuilder &builder, llvm::Value *val, llvm::Value *ptr,
...
llvm::StoreInst *
MakeStore(NomBuilder &builder, llvm::Value *val, llvm::Value *ptr,
          llvm::PointerType *asType, llvm::ArrayRef<llvm::Value *> indices,
          llvm::AtomicOrdering ordering = llvm::AtomicOrdering::Unordered);
llvm::StoreInst *
MakeStore(NomBuilder &builder, llvm::Value *val, llvm::Value *ptr,
          llvm::Value *index,
...
llvm::StoreInst *MakeInvariantStore(
    NomBuilder &builder, llvm::Module &mod, llvm::Value *val, llvm::Value *ptr,
    llvm::AtomicOrdering ordering = llvm::AtomicOrdering::Unordered);
llvm::StoreInst *MakeInvariantStore(
    NomBuilder &builder, llvm::Value *val, llvm::Value *ptr,
    llvm::AtomicOrdering ordering = llvm::AtomicOrdering::Unordered);
llvm::StoreInst *MakeInvariantStore(
    NomBuilder &builder, llvm::Value *val, llvm::Value *ptr,
    llvm::ArrayRef<llvm::Value *> indices,
...
llvm::StoreInst *MakeInvariantStore(
    ...
    llvm::AtomicOrdering ordering = llvm::AtomicOrdering::Unordered);
llvm::StoreInst *MakeInvariantStore(
    NomBuilder &builder, llvm::Value *val, llvm::Value *ptr, llvm::Value *index,
    llvm::AtomicOrdering ordering = llvm::AtomicOrdering::Unordered);
llvm::StoreInst *MakeInvariantStore(
    NomBuilder &builder, llvm::Value *val, llvm::Value *ptr,
    llvm::PointerType *asType, llvm::Value *index,
...
llvm::LoadInst *
MakeLoad(NomBuilder &builder, llvm::Module &mod, llvm::Value *ptr,
         llvm::AtomicOrdering ordering = llvm::AtomicOrdering::Unordered);
llvm::LoadInst *
MakeLoad(NomBuilder &builder, llvm::Value *ptr, llvm::Twine name = "",
         llvm::AtomicOrdering ordering = llvm::AtomicOrdering::Unordered);
llvm::LoadInst *
MakeLoad(NomBuilder &builder, llvm::Value *ptr,
         llvm::ArrayRef<llvm::Value *> indices, llvm::Twine name = "",
         llvm::AtomicOrdering ordering = llvm::AtomicOrdering::Unordered);
llvm::LoadInst *
MakeLoad(NomBuilder &builder, llvm::Value *ptr, llvm::PointerType *asType,
         llvm::ArrayRef<llvm::Value *> indices, llvm::Twine name = "",
         llvm::AtomicOrdering ordering = llvm::AtomicOrdering::Unordered);
llvm::LoadInst *
MakeLoad(NomBuilder &builder, llvm::Value *ptr, llvm::Value *index,
         llvm::Twine name = "",
         llvm::AtomicOrdering ordering = llvm::AtomicOrdering::Unordered);

llvm::LoadInst *MakeInvariantLoad(
    NomBuilder &builder, llvm::Module &mod, llvm::Value *ptr,
    llvm::AtomicOrdering ordering = llvm::AtomicOrdering::Unordered);
llvm::LoadInst *MakeInvariantLoad(
    NomBuilder &builder, llvm::Value *ptr, llvm::Twine name = "",
    llvm::AtomicOrdering ordering = llvm::AtomicOrdering::Unordered);
llvm::LoadInst *MakeInvariantLoad(
    NomBuilder &builder, llvm::Value *ptr,
    llvm::ArrayRef<llvm::Value *> indices, llvm::Twine name = "",
    llvm::AtomicOrdering ordering = llvm::AtomicOrdering::Unordered);
llvm::LoadInst *MakeInvariantLoad(
    NomBuilder &builder, llvm::Value *ptr, llvm::PointerType *asType,
    llvm::ArrayRef<llvm::Value *> indices, llvm::Twine name = "",
    llvm::AtomicOrdering ordering = llvm::AtomicOrdering::Unordered);
llvm::LoadInst *MakeInvariantLoad(
    NomBuilder &builder, llvm::Value *ptr, llvm::Value *index,
    llvm::Twine name = "",
    llvm::AtomicOrdering ordering = llvm::AtomicOrdering::Unordered);
...
MakeInt(T val) {
  return llvm::ConstantInt::get(llvm::IntegerType::get(LLVMCONTEXT, bitsin(T)),
                                bit_cast<uint64_t, T>(val),
...
template <typename T> inline llvm::ConstantInt *MakeInt32(T val) {
  static_assert(sizeof(T) == sizeof(unsigned char),
                "This is definitely not a correct enum");
