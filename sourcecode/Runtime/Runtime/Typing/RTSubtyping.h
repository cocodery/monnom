...
public:
  ...
  static llvm::Value *CreateTypeSubtypingCheck(NomBuilder &builder,
                                               llvm::Module &mod,
                                               llvm::Value *left,
                                               llvm::Value *right,
  ...
  static void CreateInlineSubtypingCheck(
      NomBuilder &builder, llvm::Value *leftType, llvm::Value *leftSubsts,
      NomTypeRef rightType, llvm::Value *rightSubstitutions,
      llvm::BasicBlock *pessimisticBlock, llvm::BasicBlock *optimisticBlock,
