...
llvm::Function *RTDisjointness::createLLVMElement(
    llvm::Module &mod, llvm::GlobalValue::LinkageTypes linkage) const {
  llvm::Function *fun = Function::Create(GetDisjointnessFunctionType(), linkage,
                                         "NOM_RT_Disjointness", &mod);
  ...
  builder->CreateRet(
      llvm::ConstantInt::get(llvm::IntegerType::getInt1Ty(LLVMCONTEXT), 0,
                             false)); // TODO: implement Disjointnesss
  return fun;
}
