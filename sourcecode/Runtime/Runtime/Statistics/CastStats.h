...
RT_NOM_STATS_IncAllocations(AllocationType at = AllocationType::General);
...
enum class NomDebugPrintValueType : unsigned char {
  Nothing = 0,
  Pointer = 1,
  Int = 2,
  Float = 3,
...
extern "C" DLLEXPORT void
RT_NOM_STATS_DebugLine(size_t funnameid, size_t linenum,
                       NomDebugPrintValueType valueType, int64_t value,
