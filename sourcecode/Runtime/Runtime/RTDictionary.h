...
namespace Runtime {
using Dicttype =
    std::unordered_map<DICTKEYTYPE, void *, std::hash<DICTKEYTYPE>,
                       std::equal_to<DICTKEYTYPE>,
                       BoehmAllocator<std::pair<const DICTKEYTYPE, void *>>>;
size_t GetConcurrentDictionarySize();
class RTDictionaryCreate : public AvailableExternally<llvm::Function>,
                           public Singleton<RTDictionaryCreate> {
...
class RTDictionaryLookup : public AvailableExternally<llvm::Function>,
                           public Singleton<RTDictionaryLookup> {
...
class RTDictionarySet : public AvailableExternally<llvm::Function>,
                        public Singleton<RTDictionarySet> {
...
class RTConcurrentDictionaryCreate
    : public AvailableExternally<llvm::Function>,
      public Singleton<RTConcurrentDictionaryCreate> {
...
class RTConcurrentDictionaryEmplace
    : public AvailableExternally<llvm::Function>,
      public Singleton<RTConcurrentDictionaryEmplace> {
...
class RTConcurrentDictionaryLookup
    : public AvailableExternally<llvm::Function>,
      public Singleton<RTConcurrentDictionaryLookup> {
...
class RTConcurrentDictionaryLookupFreeze
    : public AvailableExternally<llvm::Function>,
      public Singleton<RTConcurrentDictionaryLookupFreeze> {
...
class RTConcurrentDictionarySet : public AvailableExternally<llvm::Function>,
                                  public Singleton<RTConcurrentDictionarySet> {
...
class RTConcurrentDictionaryGetCastTypeCount
    : public AvailableExternally<llvm::Function>,
      public Singleton<RTConcurrentDictionaryGetCastTypeCount> {
...
class RTConcurrentDictionaryGetCastType
    : public AvailableExternally<llvm::Function>,
      public Singleton<RTConcurrentDictionaryGetCastType> {
...
// class RTConcurrentDictionaryEnterCast : public
// AvailableExternally<llvm::Function>, public Singleton<
...
//	static llvm::FunctionType* GetFunctionType();
//	// Inherited via AvailableExternally
//	virtual llvm::Function* createLLVMElement(llvm::Module& mod,
// llvm::GlobalValue::LinkageTypes linkage) const override; 	virtual
// llvm::Function* findLLVMElement(llvm::Module& mod) const override;
//};

class RTConcurrentDictionaryAddCastType
    : public AvailableExternally<llvm::Function>,
      public Singleton<RTConcurrentDictionaryAddCastType> {
