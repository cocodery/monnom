...
void *Nom::Runtime::gcalloc(size_t count) { return GC_MALLOC(count); }

void Nom::Runtime::gcfree(void *ref) { GC_FREE(ref); }
...
void Nom::Runtime::nfree(void *ref) { gcfree(ref); }

void *Nom::Runtime::nmalloc(size_t count) { return malloc(count); }

void Nom::Runtime::nmfree(void *ref) { free(ref); }
