...
ORIG=`pwd`
cd "$MONNOMBASE"
python3 $(MONNOMBASE)/scripts/python/run-csharp-sieve.py "$MONNOMBASE"
python3 $(MONNOMBASE)/scripts/python/run-java-sieve.py "$MONNOMBASE"
python3 $(MONNOMBASE)/scripts/python/run-node-sieve.py "$MONNOMBASE"
